...
public class Tienda {
	...
	public static final ArrayList<InfoReloj> PAQUETESRELOJ = new ArrayList<InfoReloj>(
			Arrays.asList(new InfoReloj("Paquete Basico", 20, 9.99), new InfoReloj("Paquete Intermedio", 50, 19.99),
					new InfoReloj("Paquete Avanzado", 100, 34.99), new InfoReloj("Paquete Experto", 250, 79.99),
