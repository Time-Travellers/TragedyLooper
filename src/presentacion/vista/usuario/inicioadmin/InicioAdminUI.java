...
public class InicioAdminUI extends JPanel implements InicioAdministradorListenable {
	...
	public InicioAdminUI(String name, int numMensajes, int propuestos, int report) {
		...
		todo.add(new PanelGrande("Mensajes:",
				new ImageIcon(getClass().getClassLoader().getResource("resources/message.png")), numMensajes,
				new ActionListener() {
		...
		todo.add(new PanelGrande("Usuarios reportados:",
				new ImageIcon(getClass().getClassLoader().getResource("resources/reportar.png")), report,
				new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
		...
		todo.add(new PanelGrande("Guiones propuestos:",
				new ImageIcon(getClass().getClassLoader().getResource("resources/guion.png")), propuestos,
				new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
