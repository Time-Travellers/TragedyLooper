...
public class BotonesPerfil extends JPanel {
	...
	private void initialize(PerfilBotonesListener list) {
		addButton("Lista de amigos", "Ver lista de amigos", (e) -> list.listaAmigos());
		addButton("Cambiar password", "Cambiar la contraseña", (e) -> list.cambiarPass());
		addButton("Modificar datos", "Modificar los datos de tu perfil", (e) -> list.modifDatos());
	}

	private void addButton(String title, String toolTipText, ActionListener listener) {
